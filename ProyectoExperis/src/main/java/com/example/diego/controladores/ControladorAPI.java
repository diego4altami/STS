package com.example.diego.controladores;
...
import com.example.diego.servicios.Servicios;
...
public class ControladorAPI {
	...
	public void agregarHobby(@PathVariable("usuario_id") Long usuario_id, @PathVariable("hobby_id") Long hobby_id) {
